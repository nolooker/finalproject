...
public class ProductRepositoryCustomImpl implements ProductRepositoryCustom{
    ...
    @Override
    public Page<ListProductDto> getMainProductPage(ProductSearchDto searchDto, Pageable pageable) {
        QProduct product=QProduct.product;
        QProductImage productImage=QProductImage.productImage;
        QueryResults<ListProductDto> results=this.queryFactory
                .select(
                        new QListProductDto(
                                product.id,
                                product.name,
        ...
        List<ListProductDto> content = results.getResults();
